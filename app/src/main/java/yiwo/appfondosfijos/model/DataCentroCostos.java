...
import yiwo.appfondosfijos.Controlador.SQL.BDCentroCostos;
import yiwo.appfondosfijos.Controlador.SQL.ConexionSQL;

public class DataCentroCostos {
    private String TAG = "DataCentroCostos";
    private ArrayList<List<String>> Fulllist = new ArrayList<>();

    private BDCentroCostos bddata = new BDCentroCostos();
